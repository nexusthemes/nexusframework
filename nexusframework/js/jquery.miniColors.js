		...
		miniColors: function(o, data) {
			...
			var destroy = function(input) {
				...
				input
					...
					.unbind('.miniColors');
				jQuery(document).unbind('.miniColors');
			};
			...
			var show = function(input) {
				...
				jQuery(document).bind('mousedown.miniColors touchstart.miniColors', function(event) {
			...
			switch(o) {
				...
				case 'readonly':
					...
					jQuery(this).each( function() {
						if( !jQuery(this).hasClass('miniColors') ) return;
						jQuery(this).prop('readonly', data);
					});
