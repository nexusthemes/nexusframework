...
<div id="order_review">
    ...
    <div class="nxs-margin-top40 nxs-clear"></div>

	<div id="payment">
		<?php if ($woocommerce->cart->needs_payment()) : ?>
		<ul class="payment_methods methods nxs-default-list">
			<?php
		...
		<div class="nxs-margin-top20 nxs-clear"></div>
		...
		<div class="form-row place-order">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="button alt nxsbutton" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
