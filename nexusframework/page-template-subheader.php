	...
	<div style="background-color: white;">
  	<div class="nxs-aligncenter960 nxs-admin-wrap" style='position:static;'>
		  <div id="wrap-header" style="padding-top: 30px;">
		    <h2><span class="nxs-icon-subheader"></span><?php nxs_l18n_e("Subheader[nxs:heading]", "nxs_td"); ?>: <?php echo $page_title; ?></h2>
		  </div>
		  <div>
	    ...
	    <div class="DISABLED_block">
	      ...
	      <?php
				...
				<div id="nxs-content" class="nxs-containshovermenu1 nxs-sitewide-element <?php echo $widescreenclass; ?>">
					<div class='nxs-subheader-container nxs-elements-container nxs-layout-editable nxs-widgets-editable nxs-post-<?php echo $postid; ?>'>
						<?php 
