...
function nxs_f_sitemap_getrenderedwidget($result)
{
	global $nxs_gl_sitemap_outputofwidgets;
	$nxs_gl_sitemap_outputofwidgets["widgetcounter"]++; 
	
	$nxs_gl_sitemap_outputofwidgets["html"] .= $result["html"];
...
{
	// hook to output of widgets
	add_filter("nxs_f_getrenderedwidget", "nxs_f_sitemap_getrenderedwidget");
	
	// instruct to render the main content
	nxs_ob_start();
	...
	<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
		<?php 
		global $nxs_gl_sitemap_outputofwidgets;
		echo $nxs_gl_sitemap_outputofwidgets["html"];
		?>
	</urlset>
	<?php
}
