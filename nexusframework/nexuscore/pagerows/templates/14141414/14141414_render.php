...
function nxs_pagerowtemplate_render_14141414_toolbox($args)
{
	extract($args);
	?>
...
function nxs_pagerowtemplate_render_14141414($args)
{
	extract($args);
	...
	if ($onderdrukcontent == '')
	{
		...
		$slot4_placeholdertemplate = nxs_getplaceholdertemplate($postid, $placeholderids[3]);
		...
		$slot4_placeholderid = "id='placeholder_" . $slot2_placeholdertemplate . "_existing_". $placeholderids[3] . "'";
		...
		$slot4_placeholderid_container = "id='placeholdercontainer_" . $slot2_placeholdertemplate . "_existing_". $placeholderids[3] . "'";
	}
	else
	{
	}
		...
		<li <?php echo $rowidattribute; ?>>
			...
			<span class="content">
				<div class="nxs-clear">
			    	...
			    	<li class="nxs-one-fourth droppable_placeholdercontainer">
				    	<span <?php echo $slot4_placeholderid; echo $imageclassattribute_slot4; ?>></span>
			    	</li>
					</ul>
				</div>
				<div class="nxs-clear"></div>
