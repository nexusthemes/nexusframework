...
function nxs_postwizard_pdt1_gettitle($args)
{
	return nxs_l18n__("Webpage title[nxs:postwizard]", "nxs_td");
}

function nxs_postwizard_pdt1_renderpreview($args)
{
	?>
	<div class="content2">
    <div class="box">
        ...
        <div class="box-content">
        	<span class='title'>
        		<?php nxs_l18n_e("Webpage preview[nxs:popup,ddl]", "nxs_td"); ?>
        	</span>
        </div>
    </div>
...
function nxs_postwizard_pdt1_home_getsheethtml($args)
{
	//
	extract($args);
  ...
  nxs_getfilteredcategories($categories, $categoriesfilters);	
	...
	<div class="nxs-admin-wrap">
		<div class="block">	
     	...
     	<?php nxs_render_popup_header(nxs_l18n__("Webpage title[nxs:popup]", "nxs_td")); ?>
			...
			<div class="nxs-popup-content-canvas-cropper">
		      ...
		      <div class="content2">
		        <div class="box">
		            ...
		            <div class="box-content">
		            	...
		            	<span class='title'><?php nxs_l18n_e("Webpage title[nxs:popup]", "nxs_td"); ?></span>
		            </div>
		        </div>
		        <div class="nxs-clear"></div>
		      </div> <!--END content-->
		      ...
		      <div class="content2">
		        <div class="box">
		            ...
		            <div class="box-content">
		            	<input type='text' id='pagetitle' type='text' placeholder='<?php nxs_l18n_e("Title of the new page[nxs:popup]", "nxs_td"); ?>' value='<?php echo $pagetitle; ?>' class="nxs_defaultenter" />
		            </div>
		        </div>
		        <div class="nxs-clear"></div>
		      </div> <!--END content-->
...
function nxs_postwizard_pdt1_setuppost($args)
{
	if ($postid == "")
	{
