...
function nxs_widgets_contactitemmultiselect_renderinformbox($args)
{
	extract($args);
...
function nxs_dataprotection_nexusframework_widget_contactitemmultiselect_getprotecteddata($args)
{
