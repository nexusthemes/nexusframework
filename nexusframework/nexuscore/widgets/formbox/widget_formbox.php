...
function nxs_widgets_formbox_gettitle() {
	return nxs_l18n__("form box", "nxs_td");
}
...
function nxs_widgets_formbox_home_getoptions($args) 
{
	...
	(
		...
		(
			"group" => nxs_widgets_formbox_getunifiedstylinggroup(),
		),		
		"fields" => array
		(
			// FORM IDENTIFICATION
			array( 
				"id" 				=> "wrapper_identification_begin",
				"type" 				=> "wrapperbegin",
			...
			array( 
				"id" 				=> "wrapper_handlesuccess_begin",
				"type" 				=> "wrapperbegin",
				"label" 			=> nxs_l18n__("Succesful submit handling", "nxs_td"),
			),
			...
			array( 
				"id" 				=> "wrapper_mailnotification_begin",
				"type" 				=> "wrapperbegin",
				"label" 			=> nxs_l18n__("E-mail notifications", "nxs_td"),
			),
			...
			array( 
				"id" 				=> "wrapper_mailnotifications_end",
				"type" 				=> "wrapperend"
			),
			...
			array( 
				"id" 				=> "wrapper_formoutput_begin",
				"type" 				=> "wrapperbegin",
				"label" 			=> nxs_l18n__("Submitted forms", "nxs_td"),
			),
