...
function nxs_widgets_contactitemattachment_gettitle()
{
	return nxs_l18n__("Attachment input", "nxs_td");
}

function nxs_widgets_contactitemattachment_getformitemsubmitresult($args)
{
...
function nxs_widgets_contactitemattachment_renderincontactbox($args)
{
	//
	extract($args);
...
function nxs_widgets_contactitemattachment_render_webpart_render_htmlvisualization($args)
{
	//
	extract($args);
...
function nxs_widgets_contactitemattachment_home_getoptions($args) 
{
	$options = array
	(
		"sheettitle" => nxs_widgets_contactitemattachment_gettitle(),
		"sheeticonid" => nxs_widgets_contactitemattachment_geticonid(),
...
function nxs_widgets_contactitemattachment_initplaceholderdata($args)
{
	extract($args);
