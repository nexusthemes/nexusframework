...
function nxs_widgets_contactitemsecret_geticonid()
{
	$widget_name = basename(dirname(__FILE__));
	return "nxs-icon-key";
}

function nxs_widgets_contactitemsecret_gettitle()
{
	return nxs_l18n__("Secret input", "nxs_td");
}

function nxs_widgets_contactitemsecret_getformitemsubmitresult($args)
{
	...
	$secretvalue = $metadata["secretvalue"];
	...
	{
		// error
		$result["validationerrors"][] = sprintf(nxs_l18n__("%s is not correct", "nxs_td"), $formlabel);
		$result["markclientsideelements"][] = $key;
	}
...
function nxs_widgets_contactitemsecret_renderincontactbox($args)
{
	extract($args);
...
function nxs_widgets_contactitemsecret_render_webpart_render_htmlvisualization($args)
{
	//
	extract($args);
	...
	$nxs_global_placeholder_render_statebag["widgetclass"] = "nxs-contactitemsecret-item";
...
function nxs_widgets_contactitemsecret_home_getoptions($args) 
{
	$options = array
	(
		"sheettitle" => nxs_widgets_contactitemsecret_gettitle(),
		"sheeticonid" => nxs_widgets_contactitemsecret_geticonid(),
...
function nxs_widgets_contactitemsecret_initplaceholderdata($args)
{
	extract($args);
...
function nxs_dataprotection_nexusframework_widget_contactitemsecret_getprotecteddata($args)
{
