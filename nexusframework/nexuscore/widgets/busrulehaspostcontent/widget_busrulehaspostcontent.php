...
function nxs_widgets_busrulehaspostcontent_geticonid() {
	$widget_name = basename(dirname(__FILE__));
	return "nxs-icon-wordpresssidebar";
}

// Setting the widget title
function nxs_widgets_busrulehaspostcontent_gettitle() {
	return nxs_l18n__("Post or page with WP backend postcontent", "nxs_td");
}
...
function nxs_widgets_busrulehaspostcontent_home_getoptions($args) 
{
	// CORE WIDGET OPTIONS
	
	$options = array
	(
		"sheettitle" => nxs_widgets_busrulehaspostcontent_gettitle(),
		"sheeticonid" => nxs_widgets_busrulehaspostcontent_geticonid(),
		"fields" => array
		(
...
function nxs_widgets_busrulehaspostcontent_render_webpart_render_htmlvisualization($args) 
{	
	// Importing variables
	extract($args);
	...
	*/
	...
	{
		//$url = nxs_geturl_home();
		$filteritemshtml = "Post/page with WP backend content";
		nxs_widgets_busrule_pagetemplate_renderrow(nxs_widgets_busrulehaspostcontent_geticonid(), $filteritemshtml, $mixedattributes);
	} 
...
function nxs_widgets_busrulehaspostcontent_initplaceholderdata($args)
{
	extract($args);
...
function nxs_busrule_busrulehaspostcontent_process($args, &$statebag)
{
	$result = array();
	$result["result"] = "OK";
