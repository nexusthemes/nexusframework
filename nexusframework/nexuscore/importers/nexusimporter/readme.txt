...
== Extension by Nexus Themes

This importer is a fork of the default WordPress Importer.
Modifications:
* Handles metadata slightly differently; \n's in post meta data
are removed if metadata value is is_serialized, and if unserialize returns false.
