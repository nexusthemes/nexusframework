...
<?php
  ...
  $trashedpagescount = count($trashedpages);
	...
	<form id='theform' method="get">
				<div id="wrap-header">
            <h2><span class="nxs-icon-header"></span><?php echo nxs_l18n__('Headers[nxs:heading]','nxs_td'); ?></h2>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" title="<?php nxs_l18n_e("New header[nxs:title]", "nxs_td"); ?>" onclick="nxs_js_popup_site_neweditsession('nieuwheaderhome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("New header[nxs:button]", "nxs_td"); ?></a>
                </li>
                </ul>
		    ...
		    <tbody>
		    		...
		    		foreach ($showpages as $currentpost)
		    		{
                        ...
                        <td>
                            ...
                            <?php
                            	$urlencbase64referringurl = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=headers"));
                            	$refurl = get_home_url() . "/?nxs_header=" . urlencode($postname) . "&urlencbase64referringurl=" . $urlencbase64referringurl;
                            ?>
