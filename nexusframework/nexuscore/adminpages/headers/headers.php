		    ...
		    <tbody>
		    		...
		    		foreach ($showpages as $currentpost)
		    		{
                        ...
                        <td>
                            ...
                            <?php
                            	$nxsrefurlspecial = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=headers"));
                            	$refurl = get_home_url() . "/?nxs_header=" . urlencode($postname) . "&nxsrefurlspecial=" . $nxsrefurlspecial;
                            ?>
