...
<?php
  ...
  $trashedpagescount = count($trashedpages);
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            <h2><span class="nxs-icon-pagedecorator"></span><?php echo nxs_l18n__('Pagedecorator[nxs:heading]','nxs_td'); ?></h2>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" onclick="nxs_js_popup_site_neweditsession('newpagedecoratorhome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("New pagedecorator[nxs:button]", "nxs_td"); ?></a>
                </li></ul>
		    ...
		    <tbody>
		    		...
		    		foreach ($showpages as $currentpost)
		    		{
                        ...
                        <td>
                            ...
                            <?php
                            	$urlencbase64referringurl = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=pagedecorators"));
                            	$refurl = get_home_url() . "/?containerpostid=&nxs_genericlist=" . urlencode($postname) . "&urlencbase64referringurl=" . $urlencbase64referringurl;
                            ?>
