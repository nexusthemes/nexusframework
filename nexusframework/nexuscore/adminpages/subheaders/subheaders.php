...
<?php
	...
	// published / nxs_subheader
	$publishedargs = array();
	$publishedargs["post_status"] = "publish";
	$publishedargs["post_type"] = "nxs_subheader";
  ...
  $trashedpagescount = count($trashedpages);
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            <h2><span class="nxs-icon-subheader"></span><?php echo nxs_l18n__('Subheader[nxs:heading]','nxs_td'); ?></h2>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" onclick="nxs_js_popup_site_neweditsession('nieuwsubheaderhome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("New subheader[nxs:button]", "nxs_td"); ?></a>
                </li></ul>
		    ...
		    <tbody>
		    		...
		    		foreach ($showpages as $currentpost)
		    		{
                        ...
                        <td>
                            ...
                            <?php
                            	$urlencbase64referringurl = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=subheaders"));
                            	$refurl = get_home_url() . "/?containerpostid=&nxs_subheader=" . urlencode($postname) . "&urlencbase64referringurl=" . $urlencbase64referringurl;
                            ?>
