...
<?php
	...
	// published / nxs_subfooter
	$publishedargs = array();
	$publishedargs["post_status"] = "publish";
	$publishedargs["post_type"] = "nxs_subfooter";
  ...
  $trashedpagescount = count($trashedpages);
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            <h2><span class="nxs-icon-subfooter"></span><?php echo nxs_l18n__('Subfooter[nxs:heading]','nxs_td'); ?></h2>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" onclick="nxs_js_popup_site_neweditsession('nieuwsubfooterhome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("New subfooter[nxs:button]", "nxs_td"); ?></a>
                </li></ul>
		    ...
		    <tbody>
		    		...
		    		foreach ($showpages as $currentpost)
		    		{
                        ...
                        <td>
                            ...
                            <?php
                            	$urlencbase64referringurl = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=subfooters"));
                            	$refurl = get_home_url() . "/?containerpostid=&nxs_subfooter=" . urlencode($postname) . "&urlencbase64referringurl=" . $urlencbase64referringurl;
                            ?>
