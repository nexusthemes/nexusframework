		    ...
		    <tbody>
		    		...
		    		foreach ($showpages as $currentpost)
		    		{
                        ...
                        <td>
                            ...
                            <?php
                            	$nxsrefurlspecial = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=subfooters"));
                            	$refurl = get_home_url() . "/?containerpostid=&nxs_subfooter=" . urlencode($postname) . "&nxsrefurlspecial=" . $nxsrefurlspecial;
                            ?>
