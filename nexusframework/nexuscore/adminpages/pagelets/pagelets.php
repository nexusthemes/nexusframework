...
<?php
	...
	// published / nxs_pagelet
	$publishedargs = array();
	$publishedargs["post_status"] = "publish";
	$publishedargs["post_type"] = "nxs_pagelet";
  ...
  $trashedpagescount = count($trashedpages);
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            <h2><span class="nxs-icon-pagelet"></span><?php echo nxs_l18n__('Pagelets[nxs:heading]','nxs_td'); ?></h2>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" title="Nieuwe pagelet" onclick="nxs_js_popup_site_neweditsession('nieuwpagelethome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("New pagelet[nxs:button]", "nxs_td"); ?></a>
                </li></ul>
