...
<?php
	...
	$publishedargs["post_type"] = "nxs_menu";
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" title="Nieuw Menu" onclick="nxs_js_popup_site_neweditsession('nieuwmenuhome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("Add menu[nxs:button]", "nxs_td"); ?></a>
                </li>
                </ul>
                ...
                <tbody>
                        ...
                        foreach ($showpages as $currentpost)
                        {
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <?php
                                 	$urlencbase64referringurl = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=menus"));
                                	$refurl = get_home_url() . "/?nxs_menu=" . urlencode($postname) . "&urlencbase64referringurl=" . $urlencbase64referringurl;
                                ?>
