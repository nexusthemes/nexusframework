...
<?php
	...
	$publishedargs["post_type"] = "nxs_list";
  ...
  $trashedpagescount = count($trashedpages);
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            <h2><span class="nxs-icon-list"></span><?php echo nxs_l18n__('Lists[nxs:heading]','nxs_td'); ?></h2>
            <h2>Lijsten</h2>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" title="Nieuwe Lijst" onclick="nxs_js_popup_site_neweditsession('nieuwlisthome'); return false;" class="nxsbutton1">Lijst toevoegen</a>
                </li>
                </ul>
                ...
                <tbody>
                        ...
                        foreach ($showpages as $currentpost)
                        {
                            ...
                            <td>
                                ...
                                <?php
                                 	$urlencbase64referringurl = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=lists"));
		                            	$refurl = get_home_url() . "/?nxs_list=" . urlencode($postname) . "&urlencbase64referringurl=" . $urlencbase64referringurl;
		                            ?>
