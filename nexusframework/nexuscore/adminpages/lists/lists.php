                ...
                <tbody>
                        ...
                        foreach ($showpages as $currentpost)
                        {
                            ...
                            <td>
                                ...
                                <?php
                                 	$nxsrefurlspecial = urlencode(base64_encode(home_url('/') . "?nxs_admin=admin&backendpagetype=lists"));
		                            	$refurl = get_home_url() . "/?nxs_list=" . urlencode($postname) . "&nxsrefurlspecial=" . $nxsrefurlspecial;
		                            ?>
