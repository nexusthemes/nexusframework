...
<?php	
	...
	if ($filter_types == "" || $filter_types == "post")
	{
		$posttypes[] = "post";
	}
...
// apply paging logic
	...
	<form id='theform' method="get">
		<div id="wrap-header">
            <h2><span class="nxs-icon-article-overview"></span><?php nxs_l18n_e("Pages[nxs:adminpage,heading]", "nxs_td"); ?></h2>
            ...
            <div class="nxs-clear padding"></div>
			    		...
			    		<select id='filter_types_picker' name="filter_types_picker">
			    			<option value="" <?php if ($filter_types == "") { echo 'selected="selected"'; } ?>><?php nxs_l18n_e("Both posts and pages", "nxs_td"); ?></option>
            ...
            <ul class="nxs-float-left meta">
                ...
                <li>
                	<a href="#" onclick="nxs_js_popup_site_neweditsession('newposthome'); return false;" class="nxsbutton1"><?php nxs_l18n_e("New page[nxs:adminpage,button]", "nxs_td"); ?></a>
                </li>   
                </ul>
